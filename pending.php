...
<?php
    ...
    $sql="select topic,department,about,date,assigned from complaint where id='$id' and status='0' order by date DESC";
    ...
    if($result->num_rows>0)
    {
        while($row=$result->fetch_assoc())
        {
            ...
            echo "<div class='m'><div id='left'><span><b>Topic: </b></span><span> <i>$rtopic</i> related problem </span><br> <span><b>Department:</b></span><span><i> $rdepart </i></span></div><div id='right'><span><b>Complaint:</b></span><span> $rabout</span><br><span><b>Date Of Registration:</b></span><span> $rdate1</span><br><span><b>In-Charge:</b></span><span> $rass</span></div></div>";
        }
    }
    else{
