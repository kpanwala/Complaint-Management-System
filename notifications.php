...
<?php
    ...
    $sql="select topic,status,department,about,date,assigned,completionDate,reason from complaint where id='$id' and done='1' order by date DESC";
    ...
    if($result->num_rows>0)
    {
        while($row=$result->fetch_assoc())
        {
            ...
            if(strcmp($stat,'-1')==0){
                ...
                <span><b>Date Of Rejection:</b></span><span> $rdate2</span><br>
                <span><b>Reason of Rejection:</b></span><span> $reason</span><br>
        ...
        echo "<h1>You dont have any new notifications !</h1>";
    }    

    $conn = new mysqli($servername, $username, $password,$db);
    $sql="update complaint set done='0' where id='$id' and done='1'";
    $result=$conn->query($sql);
    $conn->close();
?>
</div>
